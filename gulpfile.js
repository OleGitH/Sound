...
gulp.task('libs', function() {
    ...
    'app/libs/swiper/swiper.min.js',
		'app/libs/jqueryMask/jquery.maskedinput.min.js',
    'app/libs/range/jquery.range-min.js',
...
gulp.task('build', ['removedist', 'buildhtml', 'imagemin', 'sass', 'libs:build'], function() {
